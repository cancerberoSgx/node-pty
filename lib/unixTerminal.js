...
var UnixTerminal = /** @class */ (function (_super) {
    ...
    UnixTerminal.prototype.write = function (data, callback) {
        return callback ? callback(this._socket.write(data, function () { return callback(true); })) : this._socket.write(data);
    };
